...
#             except KeyError:
#                 # Find variable.
#                 if int_path in self._comp.unknowns:
#                     iotype = 'out'
#                     val = self._comp.unknowns[int_path]
#                     wrapper_class = _find_var_wrapper(val)
#                 else: # must be a param
#                     iotype = 'in'
#                     val = self._rec_get_param(self._comp, int_path)
#                     wrapper_class = _find_var_wrapper(val)
#
...
#                 # Wrap it.
#                 wrapper = wrapper_class(self._comp, rpath, epath, self._logger)
...
#             return map_value
#
#     def _rec_get_param(self, system, absname):
#         parts = absname.rsplit('.', 1)
#         if len(parts) == 1:
#             return system.params[absname]
#         else:
#             grp = system._subsystem(parts[0])
